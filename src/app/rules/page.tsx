  ...
  return (
    <main className="min-h-screen bg-[#0C0C0C]">
      ...
      <section className="pt-24 sm:pt-36 pb-20 sm:pb-28">
        <div className="max-w-[1100px] mx-auto px-6 sm:px-10 lg:px-12">
          ...
          >
            ...
            <p className="text-lg text-[#999999] leading-[1.9] max-w-[600px]">
      ...
      <section className="pb-20 sm:pb-24">
        <div className="max-w-[1100px] mx-auto px-6 sm:px-10 lg:px-12">
          <div className="p-8 sm:p-10 bg-[rgba(245,158,11,0.06)] border border-[rgba(245,158,11,0.3)] flex gap-6">
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-sm text-[rgba(245,158,11,0.7)] leading-[1.9]">
      ...
      <section className="py-24 sm:py-32 bg-[#0A0A0A]">
        <div className="max-w-[1100px] mx-auto px-6 sm:px-10 lg:px-12">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-white tracking-[-1px] mb-14 sm:mb-16">
            Getting Started
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="p-10 sm:p-12 bg-[#1A1A1A] border border-[#2A2A2A] flex flex-col gap-7"
              >
                <div className="w-16 h-16 bg-[rgba(255,0,0,0.08)] flex items-center justify-center">
                  {item.icon}
                </div>
                <h3 className="text-xl font-bold text-white">{item.title}</h3>
                <p className="text-[15px] text-[#999999] leading-[2]">{item.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="flex flex-col gap-8">
            {rules.map((mode, index) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: index * 0.1 }}
                className="p-10 sm:p-12 bg-[#1A1A1A] border border-[#2A2A2A] flex flex-col md:flex-row gap-8 md:gap-12"
              >
                <div className="flex items-start gap-6 md:min-w-[320px]">
                  <div
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="text-xl font-bold text-white tracking-[1px]">{mode.title}</h3>
                    <p className="text-sm text-[#777777] leading-relaxed">{mode.description}</p>
                  </div>
                </div>
                <ul className="flex flex-col gap-4 flex-1">
                  {mode.rules.map((rule, ruleIndex) => (
                    <li key={ruleIndex} className="flex items-start gap-4">
                      <span className="text-[#FF0000] mt-2 text-[6px]">●</span>
                      <span className="text-[15px] text-[#999999] leading-[1.9]">{rule}</span>
                    </li>
                  ))}
                </ul>
              </motion.div>
      ...
      <section className="py-24 sm:py-32 bg-[#0A0A0A]">
        <div className="max-w-[1100px] mx-auto px-6 sm:px-10 lg:px-12">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-white tracking-[-1px] mb-5">
            Intensity Levels
          </h2>
          <p className="text-base text-[#777777] leading-[1.9] mb-14 sm:mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            {intensityLevels.map((level, index) => (
              <motion.div
                ...
                className="p-8 sm:p-10 bg-[#1A1A1A] border border-[#2A2A2A] flex flex-col items-center text-center gap-4"
              >
                <span className="text-4xl sm:text-5xl font-extrabold" style={{ color: level.color }}>{level.multiplier}</span>
                <span className="text-sm font-bold text-white tracking-[2px]">{level.name}</span>
                <span className="text-[13px] text-[#777777] leading-relaxed">{level.description}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* CTA */}
      <section className="py-28 sm:py-36 border-t border-[#222222]">
        <div className="max-w-[1100px] mx-auto px-6 sm:px-10 lg:px-12 text-center">
          <h2 className="text-3xl sm:text-[40px] font-extrabold text-white tracking-[-2px] mb-12">
            Ready to Play?
          </h2>
          <div className="flex justify-center gap-5 flex-wrap">
            <Link
              href="/lobby/create"
              className="flex items-center gap-3.5 py-5 px-12 bg-[#FF0000] text-sm font-bold text-[#0C0C0C] tracking-[2px] no-underline hover:bg-[#E50000] active:scale-[0.97] transition-all"
            >
            ...
            <Link
              href="/lobby/join"
              className="flex items-center gap-3.5 py-5 px-12 border border-[#333333] text-sm font-bold text-white tracking-[2px] no-underline hover:border-[#FF0000] active:scale-[0.97] transition-all"
            >
              JOIN GAME
            </Link>
          </div>
