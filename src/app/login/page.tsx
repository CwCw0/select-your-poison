...
import { Skull, LogIn, Eye, EyeOff, MessageCircle, Circle } from 'lucide-react';
      ...
      <div style={{
        ...
        >
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
            ...
            {/* Forgot Password */}
            <span style={{ fontSize: '13px', color: '#666666', fontFamily: 'var(--font-space-mono), monospace', fontWeight: 500, cursor: 'default' }}>
          ...
          <div style={{ display: 'flex', gap: '16px' }}>
            ...
            >
              <Circle style={{ width: '20px', height: '20px', color: '#FFFFFF' }} />
