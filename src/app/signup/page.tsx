...
import { Skull, UserPlus, Eye, EyeOff, MessageCircle, Globe } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const [validationErrors, setValidationErrors] = useState<{ gamertag?: string; email?: string; password?: string; age?: string }>({});

  const validateForm = () => {
    const errors: { gamertag?: string; email?: string; password?: string; age?: string } = {};
    ...
    if (!ageConfirmed) {
      errors.age = 'You must confirm you are of legal drinking age';
    }
    ...
    <main style={{ minHeight: '100vh', height: '100vh', backgroundColor: '#0C0C0C', display: 'flex', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        >
          ...
          <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
              ...
              <label htmlFor="age-confirm" style={{
                fontSize: '13px',
                color: validationErrors.age ? '#EF4444' : '#999999',
                fontFamily: 'var(--font-space-mono), monospace',
                lineHeight: 1.5,
                cursor: 'pointer',
              }}>
                I confirm I am of legal drinking age (21+ in the US) and accept the{' '}
                <Link href="/terms" style={{ color: '#FF0000', textDecoration: 'underline' }}>Terms of Service</Link>
                {' '}and{' '}
                <Link href="/privacy" style={{ color: '#FF0000', textDecoration: 'underline' }}>Privacy Policy</Link>.
              </label>
            </div>
            {validationErrors.age && (
              <span style={{ fontSize: '11px', color: '#EF4444', fontFamily: 'var(--font-space-mono), monospace' }}>
                {validationErrors.age}
              </span>
            )}
            ...
            <button
              ...
              style={{
                ...
                opacity: isLoading || !ageConfirmed ? 0.5 : 1,
                marginTop: '16px'
              }}
            >
          ...
          <p style={{ textAlign: 'center', fontSize: '11px', color: '#666666', fontFamily: 'var(--font-space-mono), monospace', letterSpacing: '1px' }}>
            SOCIAL LOGIN COMING SOON
          </p>
